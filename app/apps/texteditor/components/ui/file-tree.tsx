...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ...
      ref={ref}
      className={cn(
        "h-full w-px absolute left-1.5 rtl:right-1.5 py-3 rounded-md",
        className
      )}
      style={{
        backgroundColor: "var(--tree-indicator-color, rgba(76, 79, 105, 0.3))",
      }}
      {...props}
    />
  );
      ...
      <AccordionPrimitive.Item value={value} className="relative">
        <AccordionPrimitive.Trigger
          ...
          className={cn(
            ...
            {
              "bg-[var(--tree-selected-bg,rgba(0,0,0,0))]": isSelected && isSelectable,
            },
